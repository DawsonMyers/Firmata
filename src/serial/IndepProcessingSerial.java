 ...
 * <p/>
 * (PROFIT: No processing.core dependencies)
 *
 * @webref
 */
public class IndepProcessingSerial implements SerialPortEventListener {
    ...
    public void setBufferUntil(boolean bufferUntil) {
    ...
    public IndepProcessingSerial() {
        this(dname, drate, dparity, ddatabits, dstopbits);
    }

    public IndepProcessingSerial(int irate) {
        this(dname, irate, dparity, ddatabits, dstopbits);
    }

    public IndepProcessingSerial(String iname, int irate) {
        this(iname, irate, dparity, ddatabits, dstopbits);
    }

    public IndepProcessingSerial(String iname) {
    ...
    public void start() {
        try {
            ...
            errorMessage("Port not found", null);

        } catch (Exception e) {
            errorMessage("start", e);
            //exception = e;
            //e.printStackTrace();
            port = null;
            input = null;
    ...
    /**
     * Should call start() after constructor (unlike Processing Serial)
     */
    public IndepProcessingSerial(String iname, int irate, char iparity, int idatabits, float istopbits) {
    ...
    static public void errorMessage(String where, Throwable e) {
        throw new RuntimeException("Error inside Serial." + where, e);
    }
}
